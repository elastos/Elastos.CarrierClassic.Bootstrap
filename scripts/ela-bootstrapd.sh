#! /bin/sh
### BEGIN INIT INFO
# Provides:          ela-bootstrapd
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Starts the Elastos Carrier bootstrapping server daemon
# Description:       Starts the Elastos Carrier bootstrapping server daemon
### END INIT INFO
